...
class TrendPeopleDetailsFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        //code goes here
        val trendPersonId = arguments?.getInt("trendPersonDetailId")
        if (trendPersonId != null) {
            trendPersonDetailVM.getTrendPersonDetails(trendPersonId, AppConstants.language)
        }else{
    ...
    private fun updateUI(trendPersonDetail: TrendPersonDetailsResponse?) {
        ...
        if (trendPersonDetail != null) {
            ...
            binding.tvTrendPersonDetailName.text = trendPersonDetail.name
